...
var TEXT_ELEMENTS = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'a', 'span', 'code pre', 'li'];

var textElements = [];

// Get all elements
TEXT_ELEMENTS.forEach(function (textEl) {
  textElements.push(document.querySelectorAll(textEl));
});

// Filter out null/empty elements
textElements = textElements.filter(function (el) {
  return el.length !== 0;
});

var flattenedTextElements = [];

textElements.forEach(function (el) {
  el.forEach(function (el) {
    return flattenedTextElements.push(el);
  });
});

flattenedTextElements.forEach(function (el) {
...
require('./src/night.js');
require('./src/day.js');
},{"./src/night.js":3,"./src/day.js":4}],7:[function(require,module,exports) {
